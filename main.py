...
def get_dataset(src, name, distribution):
    ...
    df['uncertainty_top'] = df['AverageTemperature']+(df['AverageTemperatureUncertainty']/1.8)
    df['uncertainty_bottom'] = df['AverageTemperature']-(df['AverageTemperatureUncertainty']/1.8)
